...
export const en: LocaleDict = {
  ...
  "settings.streamingCaptionsHint": "While you talk, a separate streaming model drafts captions word by word; the final text still comes from your selected model when you release. Requires a one-time ~167MB download; falls back to the current caption method until ready.",
