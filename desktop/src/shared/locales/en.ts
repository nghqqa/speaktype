...
export const en: LocaleDict = {
  ...
  "settings.streamingCaptions": "Live captions (streaming model)",
  "settings.streamingCaptionsHint": "While you talk, a separate streaming model drafts captions word by word; the final text still comes from your selected model when you release. Requires a one-time ~167MB download; falls back to the current caption method until ready. Only active while the recognizer is set to built-in offline recognition.",
  "settings.streamingCaptionsModel": "Streaming caption model",
  "settings.streamingCaptionsNotReady": "Toggle is on but the model is not ready — dictations keep using the current caption method (some models have no live captions).",
