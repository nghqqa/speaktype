...
export const zhTW: LocaleDict = {
  ...
  "settings.streamingCaptionsHint": "聽寫時由獨立流式模型逐字生成草稿字幕，鬆手後仍用目前模型出終稿。需先下載約 167MB 的流式模型，未就緒時自動回退現有字幕方式。",
  ...
  "settings.autoUpdateCheck": "自動檢查更新",
  "settings.autoUpdateCheckHint":
    "啟動後向 GitHub 查詢一次最新版本號（只請求版本號，不上傳任何你的資訊）。關閉後完全離線，仍可在關於頁手動檢查。",
  ...
  "settings.about.checking": "正在檢查更新…",
  "settings.about.upToDate": "已是最新版本（{{version}}）",
  "settings.about.checkFailed": "檢查更新失敗：{{reason}}",
  "settings.about.checkFailedNetwork": "無法連線 GitHub",
  "settings.about.checkFailedRateLimit": "GitHub 介面存取過於頻繁，請稍後再試",
  "settings.about.checkFailedServer": "GitHub 回傳了錯誤",
  "settings.about.checkFailedOther": "回傳內容異常",
  "settings.about.autoCheckOffHint": "自動檢查更新已關閉——在你點「檢查更新」之前不會發出任何請求。",
  ...
  "settings.about.privacyDesc":
    "所有配置（熱鍵、人設、詞典、金鑰）都儲存在本機 %APPDATA%\\SpeakType 下；歷史記錄僅存本地，可隨時清空。除你自己配置的識別/潤色服務外，SpeakType 唯一會自行發起的連線是可關閉的版本檢查（設定 → 通用 → 自動檢查更新，只向 GitHub 請求版本號）。",
