...
export const ko: LocaleDict = {
  ...
  "settings.streamingCaptionsHint": "받아쓰기 중 별도의 스트리밍 모델이 한 글자씩 초안 자막을 만들고, 손을 뗀 후 최종 텍스트는 현재 선택한 모델로 출력됩니다. 약 238MB 모델을 한 번 받아야 하며, 준비될 때까지는 기존 자막 방식으로 자동 대체됩니다. 기본 제공 오프라인 인식 사용 시에만 적용됩니다.",
