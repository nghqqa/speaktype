...
| 平台 | 下载 | 状态 |
|---|---|---|
| Windows 10/11 x64 | [SpeakType-Setup-0.20.1.exe](https://github.com/wookat/speaktype/releases/download/v0.20.1/SpeakType-Setup-0.20.1.exe)（~110MB） | ✅ 稳定 |
| Windows 绿色免安装 | [SpeakType-0.20.1-portable.exe](https://github.com/wookat/speaktype/releases/download/v0.20.1/SpeakType-0.20.1-portable.exe)（~97MB） | ✅ 稳定 |
